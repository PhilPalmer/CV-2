...
\begin{center}
    ...
    % mail to
    \href{mailto:philpalmer1997@gmail.com}{\color{teal}philpalmer1997@gmail.com} \\
...
%----------- TAGLINE -----------
\begin{center}
  Bioinformatician with six years of experience across academia, industry, and policy. Formerly at the University of Cambridge, MIT, and Lifebit Biotech. Passionate about leveraging computational biology to help create a world that's safe from pandemics.
\end{center}
...
\begin{tabularx}{\linewidth}{@{}p{2cm}@{\hspace{5pt}}|@{\hspace{5pt}}X@{}}
  Jul. 2025 -- & 
  \textbf{Consultant $|$ Nuclear Threat Initiative (NTI)} \\
  Present & \begin{minipage}[t]{\linewidth}
      \begin{itemize}[noitemsep]
          \item Developing biosecurity screening for protein design tools using protein language models.
      \end{itemize}
  \end{minipage} \\
  Feb. 2025 -- & 
  \textbf{Consultant $|$ Centre for Long-Term Resilience (CLTR)} \\
  Mar. 2025 & \begin{minipage}[t]{\linewidth}
      \begin{itemize}[noitemsep]
          \item Evaluated narrow AI-enabled biological tools to assess their dual-use risks as part of the CLTR-RAND \href{https://www.rand.org/randeurope/research/projects/2024/ai-risk-index.html}{\color{teal}Risk Index project}, informing policy efforts to reduce the risk of AI-enabled biothreats.
      \end{itemize}
  \end{minipage} \\
  Oct. 2022 -- & 
...
\begin{tabularx}{\linewidth}{@{}p{2cm}@{\hspace{5pt}}|@{\hspace{5pt}}X@{}}
    2021 -- now & 
    \textbf{Research Lead $|$ Cambridge Biosecurity Hub (CBH)} \\
    & Scaled \href{https://www.cambiohub.org/}{\color{teal}CBH} from 0 to 30+ members, helped organise the weekly reading group and mentored two graduate students for a 7-week biosecurity project to quantiatively estimate pandemic risks. \\
\end{tabularx}
...
\begin{tabularx}{\linewidth}{@{}p{2cm}@{\hspace{5pt}}|@{\hspace{5pt}}X@{}}
    2025 & 
    \textit{Covering All Bases: A Computational Method to Design Broad-spectrum T-cell-inducing Vaccines Applied to Betacoronaviruses} $|$ In Submission \\
    & \textbf{Palmer P}, Fedosyuk S, Parthasarathy S, George C, Holbrook J, O'Reilly L, Wiegand L, Carnell GW, Heeney JL and Vishwanath S. \\
    2024 & 
    \textit{\href{https://www.biorxiv.org/content/10.1101/2024.11.14.623359v1.abstract}{\color{teal}Digitally Immune Optimised Haemagglutinin with Nanocage Plug-and-Display Elicits Broadly Neutralising Pan-H5 Influenza Subtype Vaccine Responses}} $|$ bioRxiv \\
    & Huang CQ, Hills RA, Carnell GW, Vishwanath S, Aguinam ET, Chan ACY, \textbf{Palmer P}, O'Reilly L, Tonks P, Temperton N, Frost SDW, Tiley LS, Howarth MR, Heeney JL. \\
    2022 & 
...
% \subsection*{\textbf{Manuscripts in Submission}}
% \begin{tabularx}{\linewidth}{@{}p{2cm}@{\hspace{5pt}}|@{\hspace{5pt}}X@{}}
%     2025 & 
%     \textit{Covering All Bases: A Computational Method to Design Broad-spectrum T-cell-inducing Vaccines Applied to Betacoronaviruses} $|$ Under Review at Nature Biomedical Engineering \\
%     & \textbf{Palmer P}, Fedosyuk S, Parthasarathy S, George C, Holbrook J, O'Reilly L, Wiegand L, Carnell GW, Heeney JL and Vishwanath S. \\
%     % 2024 & 
...
\begin{tabularx}{\linewidth}{@{}p{2cm}@{\hspace{5pt}}|@{\hspace{5pt}}X@{}}
    2023 & 
    \textbf{Contributor $|$ \href{https://github.com/nf-core/mag}{\color{teal}nf-core/mag}} (232 stars) \\
    ...
    2020 &
    \textbf{Contributor $|$ \href{https://github.com/apriha/snps}{\color{teal}apriha/snps}} (108 stars) \\
